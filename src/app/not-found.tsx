...
export default function NotFound() {
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center gap-4 py-24 animate-fade animate-duration-300 animate-ease-in">
        <svg
          className="w-1/2 md:w-1/3 lg:w-1/4 text-indigo-600"
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-neutral-700 mt-8">
            404
          </p>
          <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-700 mt-2">
            Página no encontrada
          </p>
          <p className="md:text-lg xl:text-xl text-neutral-600 mt-4 max-w-sm">
            Lo sentimos, la página que estás buscando no está disponible. Puede
            que haya sido eliminada o que nunca existió.
          </p>
          <Link
            href="/"
            className="mt-6 px-6 py-3 bg-neutral-700 text-white rounded-lg shadow-md hover:bg-neutral-800 active:bg-neutral-800 transition"
          >
            Regresar al inicio
          </Link>
        </div>
